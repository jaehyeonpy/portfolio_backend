...
import com.portfolio.config.DataConfig;
...
// but Spring needs to register beans which requires to use test utilities Spring provides,
...
class VideoPersonalityPerformanceTest {
    ...
    @Autowired
    private VideoPersonalityFetchWithDefaultMongoService defaultMongoService;

    @Autowired
    private VideoPersonalityFetchWithMongoConnectionPoolService mongoConnectionPoolService;

    @Autowired
    private MongoCollection<Document> characterAPersonalityCollection;
