...
class VideoPersonalityPerformanceTest {
    ...
    void testDefaultMongoPerformance() throws InterruptedException {
        ...
        double sum = elapsedTimeList.stream()
                .mapToDouble(Double::doubleValue)
                .sum();

        System.out.println("==========");
        System.out.println("test: " + "default mongodb");
        System.out.println("sum of elapsedTimeList: " + sum);
        System.out.println("num of elapsedTimeList: " + elapsedTimeList.size());
        System.out.println("avg of elapsedTimeList: " + (sum / elapsedTimeList.size()));
    }

    @Test
    void testMongoWithConnectionPoolPerformance() throws InterruptedException {
        List<Double> elapsedTimeList = Collections.synchronizedList(new ArrayList<>());
        List<Thread> threads = new ArrayList<>();
        ...
        for (int i = 0; i < NUM_OF_REQUESTS; i++) {
            threads.add(new Thread(() -> {
                long startTime = System.nanoTime();
                mongoConnectionPoolService.fetchVideoPersonality(VIDEO_PERSONALITY_DOC_ID);
                long endTime = System.nanoTime();
                double elapsedSeconds = (endTime - startTime) / 1_000_000_000.0;
                System.out.println(elapsedSeconds);
                elapsedTimeList.add(elapsedSeconds);
        ...
        System.out.println("==========");
        System.out.println("test: " + "mongodb with connection pool");
        System.out.println("sum of elapsedTimeList: " + sum);
        System.out.println("num of elapsedTimeList: " + elapsedTimeList.size());
        System.out.println("avg of elapsedTimeList: " + (sum / elapsedTimeList.size()));
    }
